...
async function seedDatabase() {
  ...
  try {
    ...
    await sql`
      ...
      VALUES 
        ('Shampoo Hidratante 500ml', 'Shampoo para cabelos ressecados', 'Shampoo', 'L\'Oréal', 85.00, 42.50, 25, 5, 'un', 'ativo'),
        ('Condicionador Reparador 500ml', 'Condicionador para cabelos danificados', 'Condicionador', 'L\'Oréal', 89.00, 44.50, 30, 5, 'un', 'ativo'),
        ('Tinta Loiro Dourado', 'Coloração permanente tom 7.3', 'Coloração', 'Wella', 45.00, 22.50, 15, 3, 'un', 'ativo'),
        ('Água Oxigenada 30vol', 'Oxidante para coloração', 'Coloração', 'Wella', 25.00, 12.50, 20, 5, 'un', 'ativo'),
        ('Esmalte Vermelho', 'Esmalte cremoso longa duração', 'Esmalte', 'Risqué', 12.00, 6.00, 50, 10, 'un', 'ativo'),
        ('Base Coat', 'Base protetora para esmalte', 'Esmalte', 'Risqué', 15.00, 7.50, 35, 8, 'un', 'ativo'),
        ('Acetona', 'Removedor de esmalte', 'Removedor', 'Impala', 8.00, 4.00, 40, 10, 'un', 'ativo'),
        ('Algodão', 'Algodão para procedimentos', 'Descartável', 'Cremer', 18.00, 9.00, 60, 15, 'pct', 'ativo'),
        ('Luvas Descartáveis', 'Luvas de procedimento', 'Descartável', 'Descarpack', 35.00, 17.50, 45, 10, 'cx', 'ativo'),
        ('Touca Descartável', 'Touca para proteção', 'Descartável', 'Descarpack', 22.00, 11.00, 80, 20, 'pct', 'ativo')
    `;
