...
export const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  return (
    <aside
      className={cn(
        "h-full bg-white border-l border-gray-200 transform transition-all duration-300 ease-in-out shadow-lg dark:bg-gray-800 dark:border-gray-700",
    ...
    >
      <div className="h-full flex flex-col relative">
        ...
        <button
          onClick={onToggle}
          className={cn(
            "absolute -left-10 top-4 bg-white border border-gray-200 rounded-l-lg p-2 flex items-center justify-center hover:bg-gray-50 shadow-sm transition-colors duration-200 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700",
