...
interface EnhancedInteractiveDashboardProps {
  darkMode: boolean;
...
const MetricCard: React.FC<MetricCardProps> = ({
  ...
  return (
    <Card
      className={cn(
        "p-4 border transition-all duration-200 group",
        style.bg,
        style.border,
        isClickable
          ? "hover:shadow-lg cursor-pointer hover:scale-102"
          : "hover:shadow-md",
      )}
      onClick={onCardClick}
    >
...
export const EnhancedInteractiveDashboard: React.FC<
  EnhancedInteractiveDashboardProps
> = ({ darkMode, onPageChange }) => {
  ...
  const handleApplyFilters = () => {
    toast({
      ...
      description: "Modal de filtros será aberto",
    });
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <KPICard
            ...
            icon={TrendingUp}
            variant="profit"
            onCardClick={() => handleNavigate("reports")}
            navigateTo="reports"
          />
          <KPICard
            title="Agendamentos"
      ...
      {/* New KPIs Section with interactive toggle */}
      <section>
        <div className="flex items-center justify-between mb-4">
        ...
        {showNewKPIs && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            <MetricCard
              ...
              onCardClick={() => handleNavigate("services")}
              navigateTo="services"
            />
            <MetricCard
              ...
              variant="info"
              description="Últimos 30 dias"
              onCardClick={() => handleNavigate("marketing")}
      ...
      {/* Communication & Marketing with navigation */}
      <section>
        <div className="flex items-center justify-between mb-4">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            {professionalOccupancy.map((prof, index) => (
              <div
                key={index}
                className="space-y-2 p-2 rounded hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer transition-colors"
                onClick={() => handleNavigate("professionals")}
              >
